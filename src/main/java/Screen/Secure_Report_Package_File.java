...
public class Secure_Report_Package_File extends Basesuit
{
	/*****************************************************************/
	/*
	...
	*/
	/*****************************************************************/
	WebDriver Driver;
	public Secure_Report_Package_File(WebDriver driver)
	{
		this.Driver=driver;
	}
	/*****************************************************************/
	...
	*/
	...
	@FindBy(xpath="//img[@alt='Viewing of Package File' and @src='static/images/um/viewPackagingFile.png']")
	@CacheLookup
	WebElement Packagefile;
	...
	*/
	...
	public void Package_file()
	{
		HighlightOnElement(Packagefile);
		waitForPageLoad(Driver, Packagefile);
		Packagefile.click();
	}
